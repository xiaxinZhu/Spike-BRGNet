...
from datasets.labels import shiftUpId, shiftDownId
from datasets.data_util import gen_edge
...
# def get_split(dirs, split):
#     return {
#         "valid": [dirs[0], dirs[2], dirs[3], dirs[5], dirs[6]],
#         "test": [dirs[4]],
#         "train": [dirs[1]]
#     }[split]
...
class DDD17Events(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        elif self.event_representation == 'voxel_grid_2':
            # x:[c',h,w]=[t*c,h,w]->[t,c,h,w]
            C, H, W = event_tensor.shape
            event_tensor = event_tensor.view(C//5, 5, H, W)
